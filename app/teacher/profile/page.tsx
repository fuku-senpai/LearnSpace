    ...
    <div className="h-full overflow-y-auto px-4 py-6 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-5xl space-y-8">
        <section className="space-y-4 border-b border-slate-200 pb-6">
          ...
          <div className="h-px w-full max-w-[100px] bg-gradient-to-r from-sky-400 to-transparent" />
          <div className="space-y-1">
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">
              Thông tin cá nhân
            </h2>
            <p className="text-sm text-slate-500">
              Quản lý hồ sơ giảng viên và thông tin chuyên môn.
            </p>
          </div>
        </section>
            ...
            <section className="rounded-2xl border border-slate-200/80 bg-white shadow-sm">
              <div className="border-b border-slate-100 px-6 py-5 sm:px-8">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Thông tin hiển thị với học viên và quản trị viên.
                </p>
              </div>
              ...
              <div className="space-y-6 px-6 py-6 sm:px-8">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
                  ...
                  <Button
                    type="submit"
                    disabled={isSaving}
                    className="h-11 w-full shrink-0 cursor-pointer rounded-xl bg-slate-900 px-6 text-white hover:bg-slate-800 sm:w-auto sm:min-w-[148px]"
                  >
