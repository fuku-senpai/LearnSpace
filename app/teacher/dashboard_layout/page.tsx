  ...
  return (
    <div className="flex min-h-screen gap-4 bg-[#f3f5f9] p-4">
      <aside className="sticky top-4 hidden h-[calc(100vh-2rem)] w-[270px] shrink-0 flex-col overflow-hidden rounded-3xl border border-white/[0.06] bg-[#0c0e14] shadow-[0_20px_50px_rgba(0,0,0,0.18)] lg:flex">
        <div className="pointer-events-none absolute inset-0 rounded-3xl bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(56,189,248,0.14),transparent_60%)]" />

        <div className="relative border-b border-white/[0.06] px-6 py-7">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400 to-sky-600 text-white shadow-[0_8px_24px_rgba(56,189,248,0.25)]">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Không gian giảng dạy</p>
            </div>
          </div>
        </div>
                  ...
                  return (
                    <button
                      ...
                      className={`group flex h-10 w-full cursor-pointer items-center gap-3 rounded-xl px-3 text-sm transition-all duration-200 ${
                        isActive
                          ? "bg-white/[0.08] text-white shadow-[inset_3px_0_0_0_#38bdf8]"
                    ...
                    >
                      ...
                      {isActive ? (
                        <ChevronRight className="ml-auto h-4 w-4 text-sky-400/80" />
                      ) : null}
                    </button>
                  );
                })}
        ...
        <header className="sticky top-0 z-20 border-b border-slate-200/70 bg-white/90 px-6 py-4 backdrop-blur-xl">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-sky-400 to-sky-600 text-xs font-bold text-white shadow-sm">
                GV
              </div>
            </div>
          </div>
