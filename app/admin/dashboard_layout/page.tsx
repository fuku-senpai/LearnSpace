...
const menuGroups: {
  title: string;
  items: { key: MenuKey; label: string }[];
}[] = [
  {
    title: "Tổng quan",
  ...
  },
  {
    ...
    items: [
      ...
      { key: "teacher-assignment", label: "Gán lớp cho giáo viên" },
    ],
  },
  {
    title: "Nội dung",
    ...
    <div className="flex min-h-screen bg-[#f4f6fb]">
      ...
      <main className="flex min-h-screen flex-1 flex-col">
        <div className="px-6 py-8">
          ...
          {activeMenu === "lessons" && <LessonManagement />}
          {activeMenu === "lessonResources" && <LessonResource />}
          {activeMenu === "records" && <RecordsManagement />}
          {activeMenu === "teacher-assignment" && <AssignTeacherToClass />}
        </div>
      </main>
    </div>
  );
